...
    // ensure score is an integer (or 0)
...
        setError(
          data.error
            ? `${data.error} - check raw_text in debug output`
...
  };
  ...
  // New function to handle the finish button click
  const finishroadmap = () => {
    navigate("/success");
  };
...
          {/* If server returned raw_text (parsing error), show it */}
          {roadmap.raw_text && (
